...
directories = []
for mod_id in ["biomesoplenty", "blue_skies", "byg", "hexcasting", "railways", "twilightforest", "natures_spirit", "create_dd", "quark"]:
...
texture_mappings = {k: k.replace(".png", "_narrow.png") for k in textures}
overlay = pygame.image.load("development_assets/track_narrow.png")
