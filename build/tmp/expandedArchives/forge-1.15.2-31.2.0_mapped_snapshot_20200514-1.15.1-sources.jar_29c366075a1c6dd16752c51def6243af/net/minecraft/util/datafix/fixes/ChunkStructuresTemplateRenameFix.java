      ...
      return this.fixTypeEverywhereTyped("ChunkStructuresTemplateRenameFix", type, (p_207911_2_) -> {
         return p_207911_2_.updateTyped(opticfinder, (p_207908_2_) -> {
            return p_207908_2_.update(DSL.remainderFinder(), (p_207909_2_) -> {
               return this.fixTag(p_207911_2_.get(DSL.remainderFinder()), p_207909_2_);
            });
         });
      });
   }

   private Dynamic<?> fixTag(Dynamic<?> p_209729_1_, Dynamic<?> p_209729_2_) {
      String s = p_209729_1_.get("id").asString("");
      if (field_207912_a.containsKey(s)) {
         Pair<String, ImmutableMap<String, String>> pair = field_207912_a.get(s);
         if (pair.getFirst().equals(p_209729_2_.get("id").asString(""))) {
            String s1 = p_209729_2_.get("Template").asString("");
            p_209729_2_ = p_209729_2_.set("Template", p_209729_2_.createString(pair.getSecond().getOrDefault(s1, s1)));
         }
      }
