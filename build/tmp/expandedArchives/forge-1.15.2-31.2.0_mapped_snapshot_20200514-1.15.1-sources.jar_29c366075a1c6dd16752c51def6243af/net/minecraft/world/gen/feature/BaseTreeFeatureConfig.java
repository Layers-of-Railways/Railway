...
public class BaseTreeFeatureConfig implements IFeatureConfig {
   ...
   public static <T> BaseTreeFeatureConfig deserialize(Dynamic<T> data) {
      ...
      return new BaseTreeFeatureConfig(blockstateprovidertype.func_227399_a_(data.get("trunk_provider").orElseEmptyMap()), blockstateprovidertype1.func_227399_a_(data.get("leaves_provider").orElseEmptyMap()), data.get("decorators").asList((p_227374_0_) -> {
