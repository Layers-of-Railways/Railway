...
package com.railwayteam.railways.content.custom_tracks.wide_gauge.fabric;
...
public class WideGaugeTrackBlockStateGeneratorImpl extends WideGaugeTrackBlockStateGenerator {
    ...
    public static WideGaugeTrackBlockStateGenerator create() {
        return new WideGaugeTrackBlockStateGeneratorImpl();
    }
}
