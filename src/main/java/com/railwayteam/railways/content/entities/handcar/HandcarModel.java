...
public class HandcarModel extends EntityModel<HandcarEntity> {
    ...
    public HandcarModel() {
        ...
        Axle2.setTextureOffset(0, 98).addBox(-1.0F, -1.0F, -13.0F, 2.0F, 2.0F, 26.0F, 0.0F, false);

        Axle1 = new ModelRenderer(this);
        Axle1.setRotationPoint(-27.0F, -16.0F, 0.2F);
        Axles.addChild(Axle1);
        Axle1.setTextureOffset(0, 98).addBox(-1.0F, -1.0F, -13.0F, 2.0F, 2.0F, 26.0F, 0.0F, false);

        WalkingBeam = new ModelRenderer(this);
        WalkingBeam.setRotationPoint(-0.2778F, -16.2222F, -0.4444F);
        WalkingBeam.setTextureOffset(0, 54).addBox(-6.2222F, -0.2778F, -7.0556F, 13.0F, 1.0F, 1.0F, 0.0F, false);
        WalkingBeam.setTextureOffset(0, 52).addBox(-1.2222F, -0.2778F, 5.9444F, 3.0F, 1.0F, 1.0F, 0.0F, false);
        WalkingBeam.setTextureOffset(0, 44).addBox(-3.7222F, -0.2778F, -0.0556F, 8.0F, 1.0F, 1.0F, 0.0F, false);
        WalkingBeam.setTextureOffset(0, 37).addBox(-2.7222F, -0.7778F, -0.5556F, 1.0F, 2.0F, 2.0F, 0.0F, false);
        WalkingBeam.setTextureOffset(0, 46).addBox(-0.2222F, -0.2778F, -5.0556F, 1.0F, 1.0F, 5.0F, 0.0F, false);
        ...
        bone3_r1.setTextureOffset(0, 52).addBox(-1.5F, -16.5F, -0.5F, 3.0F, 1.0F, 1.0F, 0.0F, false);
        ...
        bone3_r2.setTextureOffset(0, 37).addBox(5.5F, -29.0F, -1.0F, 1.0F, 2.0F, 2.0F, 0.0F, false);
        ...
        bone3_r3.setTextureOffset(0, 46).addBox(-0.5F, -16.5F, -2.5F, 1.0F, 1.0F, 5.0F, 0.0F, false);
        ...
        bone3_r4.setTextureOffset(0, 54).addBox(-6.5F, -16.5F, -0.5F, 13.0F, 1.0F, 1.0F, 0.0F, false);
        ...
        octagon_r1.setTextureOffset(118, 110).addBox(-0.5001F, 11.0F, -2.0711F, 1.0F, 10.0F, 4.0F, 0.0F, false);
        octagon_r1.setTextureOffset(106, 111).addBox(-0.5001F, 13.9289F, -5.0F, 1.0F, 4.0F, 10.0F, 0.0F, false);
        ...
        octagon_r2.setTextureOffset(118, 111).addBox(-0.5001F, 6.3137F, 9.2426F, 1.0F, 10.0F, 4.0F, 0.0F, false);
        octagon_r2.setTextureOffset(106, 111).addBox(-0.5001F, 9.2426F, 6.3137F, 1.0F, 4.0F, 10.0F, 0.0F, false);
        ...
        octagon_r3.setTextureOffset(0, 111).addBox(-1.0001F, 12.0F, -1.6569F, 2.0F, 8.0F, 3.0F, 0.0F, false);
        octagon_r3.setTextureOffset(33, 110).addBox(-1.0001F, 14.3431F, -4.0F, 2.0F, 3.0F, 8.0F, 0.0F, false);
        ...
        octagon_r4.setTextureOffset(72, 114).addBox(-1.0001F, 7.3137F, 9.6569F, 2.0F, 8.0F, 3.0F, 0.0F, false);
        octagon_r4.setTextureOffset(0, 97).addBox(-1.0001F, 9.6569F, 7.3137F, 2.0F, 3.0F, 8.0F, 0.0F, false);
        ...
        octagon_r5.setTextureOffset(118, 110).addBox(-0.5001F, 11.0F, -2.0711F, 1.0F, 10.0F, 4.0F, 0.0F, false);
        octagon_r5.setTextureOffset(106, 111).addBox(-0.5001F, 13.9289F, -5.0F, 1.0F, 4.0F, 10.0F, 0.0F, false);
        ...
        octagon_r6.setTextureOffset(118, 111).addBox(-0.5001F, 6.3137F, 9.2426F, 1.0F, 10.0F, 4.0F, 0.0F, false);
        octagon_r6.setTextureOffset(106, 111).addBox(-0.5001F, 9.2426F, 6.3137F, 1.0F, 4.0F, 10.0F, 0.0F, false);
        ...
        octagon_r7.setTextureOffset(0, 111).addBox(-1.0001F, 12.0F, -1.6569F, 2.0F, 8.0F, 3.0F, 0.0F, false);
        octagon_r7.setTextureOffset(33, 110).addBox(-1.0001F, 14.3431F, -4.0F, 2.0F, 3.0F, 8.0F, 0.0F, false);
        ...
        octagon_r8.setTextureOffset(72, 114).addBox(-1.0001F, 7.3137F, 9.6569F, 2.0F, 8.0F, 3.0F, 0.0F, false);
        octagon_r8.setTextureOffset(0, 97).addBox(-1.0001F, 9.6569F, 7.3137F, 2.0F, 3.0F, 8.0F, 0.0F, false);
        ...
        octagon_r9.setTextureOffset(118, 110).addBox(-0.5F, 11.0F, -2.071F, 1.0F, 10.0F, 4.0F, 0.0F, false);
        octagon_r9.setTextureOffset(106, 111).addBox(-0.5F, 13.9289F, -4.9999F, 1.0F, 4.0F, 10.0F, 0.0F, false);
        ...
        octagon_r10.setTextureOffset(118, 111).addBox(-0.5F, 6.3136F, 9.2427F, 1.0F, 10.0F, 4.0F, 0.0F, false);
        octagon_r10.setTextureOffset(106, 111).addBox(-0.5F, 9.2426F, 6.3138F, 1.0F, 4.0F, 10.0F, 0.0F, false);
        ...
        octagon_r11.setTextureOffset(0, 111).addBox(-1.0F, 12.0F, -1.657F, 2.0F, 8.0F, 3.0F, 0.0F, false);
        octagon_r11.setTextureOffset(33, 110).addBox(-1.0F, 14.3431F, -4.0001F, 2.0F, 3.0F, 8.0F, 0.0F, false);
        ...
        octagon_r12.setTextureOffset(72, 114).addBox(-1.0F, 7.3138F, 9.6568F, 2.0F, 8.0F, 3.0F, 0.0F, false);
        octagon_r12.setTextureOffset(0, 97).addBox(-1.0F, 9.6569F, 7.3136F, 2.0F, 3.0F, 8.0F, 0.0F, false);
        ...
        octagon_r13.setTextureOffset(118, 110).addBox(-0.5F, 11.0F, -2.0712F, 1.0F, 10.0F, 4.0F, 0.0F, false);
        octagon_r13.setTextureOffset(106, 111).addBox(-0.5F, 13.9289F, -5.0001F, 1.0F, 4.0F, 10.0F, 0.0F, false);
        ...
        octagon_r14.setTextureOffset(118, 111).addBox(-0.5F, 6.3138F, 9.2426F, 1.0F, 10.0F, 4.0F, 0.0F, false);
        octagon_r14.setTextureOffset(106, 111).addBox(-0.5F, 9.2427F, 6.3136F, 1.0F, 4.0F, 10.0F, 0.0F, false);
        ...
        octagon_r15.setTextureOffset(0, 111).addBox(-1.0F, 12.0F, -1.657F, 2.0F, 8.0F, 3.0F, 0.0F, false);
        octagon_r15.setTextureOffset(33, 110).addBox(-1.0F, 14.3431F, -4.0001F, 2.0F, 3.0F, 8.0F, 0.0F, false);
        ...
        octagon_r16.setTextureOffset(72, 114).addBox(-1.0F, 7.3138F, 9.6568F, 2.0F, 8.0F, 3.0F, 0.0F, false);
        octagon_r16.setTextureOffset(0, 97).addBox(-1.0F, 9.6569F, 7.3136F, 2.0F, 3.0F, 8.0F, 0.0F, false);

        Body = new ModelRenderer(this);
        Body.setRotationPoint(-6.1667F, 6.9017F, -1.4424F);
        setRotationAngle(Body, 0.0F, 3.1416F, 0.0F);
        Body.setTextureOffset(42, 84).addBox(-13.8333F, -8.9017F, -22.5576F, 1.0F, 2.0F, 42.0F, 0.0F, false);
        ...
        wheel_beam2_r1.setTextureOffset(62, 16).addBox(-0.5F, -18.0F, -20.0F, 18.0F, 1.0F, 15.0F, 0.0F, false);
        wheel_beam2_r1.setTextureOffset(62, 0).addBox(-0.5F, -18.0F, 5.0F, 18.0F, 1.0F, 15.0F, 0.0F, false);
        wheel_beam2_r1.setTextureOffset(114, 56).addBox(10.5F, -30.0F, -3.0F, 1.0F, 1.0F, 6.0F, 0.0F, false);
        wheel_beam2_r1.setTextureOffset(94, 56).addBox(11.5F, -20.0F, -8.0F, 1.0F, 2.0F, 16.0F, 0.0F, false);
        wheel_beam2_r1.setTextureOffset(94, 56).addBox(4.5F, -20.0F, -8.0F, 1.0F, 2.0F, 16.0F, 0.0F, false);
        wheel_beam2_r1.setTextureOffset(114, 56).addBox(5.5F, -30.0F, -3.0F, 1.0F, 1.0F, 6.0F, 0.0F, false);
        wheel_beam2_r1.setTextureOffset(67, 43).addBox(-0.5F, -18.0F, -5.0F, 7.0F, 1.0F, 10.0F, 0.0F, false);
        wheel_beam2_r1.setTextureOffset(42, 84).addBox(0.5F, -17.0F, -21.0F, 1.0F, 2.0F, 42.0F, 0.0F, false);
        ...
        wheel_beam2_r2.setTextureOffset(118, 34).addBox(-4.5F, -11.6662F, -8.486F, 4.0F, 1.0F, 1.0F, 0.0F, false);
        wheel_beam2_r2.setTextureOffset(100, 42).addBox(-5.5F, -11.6662F, -12.486F, 1.0F, 1.0F, 13.0F, 0.0F, false);
        wheel_beam2_r2.setTextureOffset(100, 42).addBox(-0.5F, -11.6662F, -12.486F, 1.0F, 1.0F, 13.0F, 0.0F, false);
        ...
        wheel_beam2_r3.setTextureOffset(114, 36).addBox(-2.0001F, -6.623F, 13.282F, 4.0F, 1.0F, 3.0F, 0.0F, false);
        ...
        wheel_beam2_r4.setTextureOffset(100, 42).addBox(-0.5F, -7.0468F, -14.3994F, 1.0F, 1.0F, 13.0F, 0.0F, false);
        ...
        wheel_beam2_r5.setTextureOffset(118, 34).addBox(-4.5F, -7.0468F, -10.3994F, 4.0F, 1.0F, 1.0F, 0.0F, false);
        wheel_beam2_r5.setTextureOffset(100, 42).addBox(-0.5F, -7.0468F, -14.3994F, 1.0F, 1.0F, 13.0F, 0.0F, false);
        ...
        wheel_beam2_r6.setTextureOffset(114, 36).addBox(-2.0F, -6.6229F, 13.2821F, 4.0F, 1.0F, 3.0F, 0.0F, false);
        ...
        wheel_beam2_r7.setTextureOffset(67, 32).addBox(-3.5F, -16.5F, -5.0F, 7.0F, 1.0F, 10.0F, 0.0F, false);
    }

    @Override
    public void setRotationAngles(HandcarEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
