...
public class TextListWidget extends Widget {
  ...
  private final LinkedHashMap<Button, TextFieldWidget> active;
  private final LinkedHashMap<Button, TextFieldWidget> graveyard;
  ...
  public ArrayList<String> getActiveValues() {
    deferredRemoval();
