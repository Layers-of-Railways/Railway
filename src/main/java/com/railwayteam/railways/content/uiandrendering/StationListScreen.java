...
import com.railwayteam.railways.base.AbstractRailwaysScreen;
import com.railwayteam.railways.content.items.StationLocation;
...
public class StationListScreen extends AbstractRailwaysScreen<StationListContainer> {
  ...
  private final ResourceLocation BG = new ResourceLocation(Railways.MODID, "textures/gui/schedule_bg.png");
  private final ResourceLocation FG = new ResourceLocation(Railways.MODID, "textures/gui/schedule_fg.png");
