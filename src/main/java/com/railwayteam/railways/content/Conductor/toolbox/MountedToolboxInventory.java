...
public class MountedToolboxInventory extends ItemStackHandler {
	...
	public MountedToolboxInventory(MountedToolboxHolder holder) {
	...
	public void inLimitedMode(Consumer<MountedToolboxInventory> action) {
		limitedMode = true;
		action.accept(this);
		limitedMode = false;
	}
	...
	public boolean isItemValid(int slot, ItemStack stack) {
		...
		if (limitedMode && filter.isEmpty())
			return false;
		if (filter.isEmpty() || MountedToolboxInventory.canItemsShareCompartment(filter, stack))
	...
	protected void onContentsChanged(int slot) {
		if (!settling && !holder.getLevel().isClientSide)
