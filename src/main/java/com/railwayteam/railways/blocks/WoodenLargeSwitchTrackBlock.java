...
public class WoodenLargeSwitchTrackBlock extends LargeSwitchTrackBlock {
  public static final String name = "wooden_large_switch";
  public WoodenLargeSwitchTrackBlock(Properties properties) {
    super(properties);
  }
