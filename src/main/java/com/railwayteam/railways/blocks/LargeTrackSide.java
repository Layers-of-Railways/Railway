...
public enum LargeTrackSide implements IStringSerializable {
  ...
  public static boolean isValid    (Vector3i a, Vector3i b) {
  ...
  public static LargeTrackSide findValidStateFrom(Vector3i a) {
  ...
  public static LargeTrackSide findValidStateFrom(Vector3i a, Vector3i b) {
