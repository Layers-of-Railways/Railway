package com.railwayteam.railways.interaction.packets;

import com.railwayteam.railways.base.CustomPacketBase;
import com.railwayteam.railways.content.uiandrendering.StationListContainer;
...
public class CustomPacketUpdateOrders extends CustomPacketBase {
      ...
      if (player.openContainer instanceof StationListContainer) {
        ...
        //  Railways.LOGGER.debug("handling minecart packet...");
          ...
          if (targetEntity instanceof AbstractMinecartEntity) {
            ...
            targetEntity.getCapability(CapabilitySetup.CAPABILITY_STATION_LIST).ifPresent(capability -> {
