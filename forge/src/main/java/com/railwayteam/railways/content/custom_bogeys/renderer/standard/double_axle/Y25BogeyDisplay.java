...
public class Y25BogeyDisplay extends CrossShaftDoubleAxleBogeyDisplay {
    public Y25BogeyDisplay(ElementProvider<?> prov) {
        super(prov, Y25_FRAME, LONG_SHAFTED_WHEELS, true);
    }
}
