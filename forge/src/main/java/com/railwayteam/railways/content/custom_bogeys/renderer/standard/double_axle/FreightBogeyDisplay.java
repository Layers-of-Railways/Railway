...
public class FreightBogeyDisplay extends CrossShaftDoubleAxleBogeyDisplay {
    public FreightBogeyDisplay(ElementProvider<?> prov) {
        super(prov, FREIGHT_FRAME, LONG_SHAFTED_WHEELS, true);
    }
}
