...
public class ModernBogeyDisplay extends DoubleAxleBogeyDisplay {
    public ModernBogeyDisplay(ElementProvider<?> prov) {
        super(prov, MODERN_FRAME, LONG_SHAFTED_WHEELS, true);
    }
}
