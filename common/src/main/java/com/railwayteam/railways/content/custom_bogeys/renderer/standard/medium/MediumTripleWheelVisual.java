...
public class MediumTripleWheelVisual implements BogeyVisual {
    ...
    public MediumTripleWheelVisual(VisualizationContext ctx, float partialTick, boolean inContraption)
    {

        frame = ctx.instancerProvider()
                .instancer(InstanceTypes.TRANSFORMED, Models.partial(MEDIUM_TRIPLE_WHEEL_FRAME))
                .createInstance();
