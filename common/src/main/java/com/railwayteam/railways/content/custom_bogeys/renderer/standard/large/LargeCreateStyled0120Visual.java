...
public class LargeCreateStyled0120Visual implements BogeyVisual {
	...
	private final TransformedInstance[] blindWheels = new TransformedInstance[2];
	...
	private final TransformedInstance[] pins = new TransformedInstance[6];
	...
	public void hide() {
		...
		for (TransformedInstance blindWheel : blindWheels)
