...
public class MediumStandardVisual implements BogeyVisual {
    ...
    public MediumStandardVisual(VisualizationContext ctx, float partialTick, boolean inContraption)
    {

        frame = ctx.instancerProvider()
                .instancer(InstanceTypes.TRANSFORMED, Models.partial(MEDIUM_STANDARD_FRAME))
                .createInstance();
