...
public class RadialBogeyVisual implements BogeyVisual {
    ...
    public RadialBogeyVisual(VisualizationContext ctx, float partialTick, boolean inContraption) {
        ctx.instancerProvider()
                .instancer(InstanceTypes.TRANSFORMED, Models.partial(SMALL_BOGEY_WHEELS))
                .createInstances(wheels);
        frame = ctx.instancerProvider()
                .instancer(InstanceTypes.TRANSFORMED, Models.partial(RADIAL_FRAME))
                .createInstance();
        ctx.instancerProvider()
