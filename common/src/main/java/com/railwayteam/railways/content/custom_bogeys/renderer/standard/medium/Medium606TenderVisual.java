...
public class Medium606TenderVisual  implements BogeyVisual {
    ...
    public Medium606TenderVisual(VisualizationContext ctx, float partialTick, boolean inContraption)
    {

        frame = ctx.instancerProvider()
                .instancer(InstanceTypes.TRANSFORMED, Models.partial(MEDIUM_6_0_6_TENDER_FRAME))
                .createInstance();
