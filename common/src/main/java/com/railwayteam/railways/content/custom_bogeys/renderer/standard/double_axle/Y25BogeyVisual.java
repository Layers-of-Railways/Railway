...
public class Y25BogeyVisual implements BogeyVisual {
	...
	public Y25BogeyVisual(VisualizationContext ctx, float partialTick, boolean inContraption) {

		frame = ctx.instancerProvider()
				.instancer(InstanceTypes.TRANSFORMED, Models.partial(Y25_FRAME))
				.createInstance();
