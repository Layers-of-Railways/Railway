...
public class Medium404TrailingVisual implements BogeyVisual {
    ...
    public Medium404TrailingVisual(VisualizationContext ctx, float partialTick, boolean inContraption)
    {

        frame = ctx.instancerProvider()
                .instancer(InstanceTypes.TRANSFORMED, Models.partial(MEDIUM_4_0_4_TRAILING_FRAME))
                .createInstance();
