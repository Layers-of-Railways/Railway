...
public class Medium808TenderVisual implements BogeyVisual {
	...
	public Medium808TenderVisual(VisualizationContext ctx, float partialTick, boolean inContraption) {

		frame = ctx.instancerProvider()
				.instancer(InstanceTypes.TRANSFORMED, Models.partial(MEDIUM_8_0_8_TENDER_FRAME))
				.createInstance();
