...
public class CRBogeyStyles {
    ...
    public static final CategoryEntry SINGLEAXLE_CATEGORY = registerCategory("singleaxles");
    public static final CategoryEntry DOUBLEAXLE_CATEGORY = registerCategory("doubleaxles");
    public static final CategoryEntry TRIPLEAXLE_CATEGORY = registerCategory("tripleaxles");
    public static final CategoryEntry QUADRUPLEAXLE_CATEGORY = registerCategory("quadrupleaxles");
    public static final CategoryEntry QUINTUPLEAXLE_CATEGORY = registerCategory("quintupleaxles");
    public static final CategoryEntry SEXTUPLEAXLE_CATEGORY = registerCategory("sextupleaxles");
