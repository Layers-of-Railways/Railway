...
import static com.railwayteam.railways.registry.CRTrackMaterials.WIDE_GAUGE;
import static com.railwayteam.railways.registry.CRTrackMaterials.WIDE_GAUGE_REVERSE;
...
public class GenericTrackCompat {
    ...
    public void register(String... names) {
        for (String name : names) {
            ...
            WIDE_GAUGE.put(standardMaterial, wideMaterial);
            WIDE_GAUGE_REVERSE.put(wideMaterial, standardMaterial);
